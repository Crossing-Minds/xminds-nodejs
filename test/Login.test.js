...
describe('LOGIN TESTS', () => {
  ...
  test('loginIndividual', async () => {
    ...
    globalThis.fetch.postOnce(opts.host + '/v1/login/individual/', expectedResponse);
  ...
  test('loginService', async () => {
    ...
    globalThis.fetch.postOnce(opts.host + '/v1/login/service/', expectedResponse, { overwriteRoutes: false });
  ...
  test('loginRoot', async () => {
    ...
    globalThis.fetch.postOnce(opts.host + '/v1/login/individual/', expectedResponse, { overwriteRoutes: false });
  ...
  test('loginRefreshToken', async () => {
    ...
    globalThis.fetch.postOnce(opts.host + '/v1/login/refresh-token/', expectedResponse, { overwriteRoutes: false });
