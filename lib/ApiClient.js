...
class ApiClient {
   ...
   */
  async loginIndividual(email, password, dbId, frontendUserId = null, frontendSessionId = null, opts = {}) {
    let bodyParams = {
      'email': email,
      'password': password,
      'db_id': dbId
   ...
   * @returns {Promise<Object>} Object represents the jwtToken, refreshToken and database information if resolved. XMindsError if rejected
   */
  async loginService(name, password, dbId, frontendUserId = null, frontendSessionId = null, opts = {}) {
    let bodyParams = {
      'name': name,
      'password': password,
      'db_id': dbId
