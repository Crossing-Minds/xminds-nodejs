...
class ApiClient {
   ...
   * @param {String} host The CrossingMinds API host (null value uses default)
   */
  constructor(refreshToken, userAgent = null, host = null) {
   ...
   * 
   */
  getRecommendationsSessionToItems(amt = null, cursor = null, filters = null, ratings = null, userProperties = null, excludeRatedItems = false, interactions = null, reranking = null, scenario = null, skipDefaultScenario = false) {
    let bodyParams = {};
    ...
    if (ratings)
      ...
      bodyParams['interactions'] = interactions;
    ...
    if (reranking)
      bodyParams['reranking'] = reranking;
    if (scenario)
      bodyParams['scenario'] = scenario;
    if (skipDefaultScenario)
      bodyParams['skip_default_scenario'] = skipDefaultScenario;
