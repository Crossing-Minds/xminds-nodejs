...
/**
   ...
   */
export function loginIndividual(email, password, dbId, frontendUserId = null, frontendSessionId = null) {
...
/**
   ...
   * @returns {Promise<Object>} Object represents the jwtToken, refreshToken and database information if resolved. XMindsError if rejected
   */
export function loginService(name, password, dbId, frontendUserId = null, frontendSessionId = null) {
